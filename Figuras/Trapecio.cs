...
namespace trabajoMayo.Figuras
{
    internal class Trapecio : Figuras
    {
        ...
        public override void CalcularArea(int baseMayor, int baseMenor, int altura)
        {
        ...
        {
            int lado = (int)Math.Sqrt(Math.Pow(((10 + baseMayor / 2 + baseMenor / 2) - (10 + baseMayor)) , 2) + Math.Pow(((10) - 10 + altura) , 2));
